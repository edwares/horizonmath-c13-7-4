...
| Other link classes | 67 `NOT_STARTED` at profile/formula depth |
...
Install the exact-proof extras to run all 40 tests:
...
The next bounded implementation stage is a no-solver census of all 68 audited
representatives. It will validate every link, compute inexpensive structural
features, and rank—not solve—the remaining classes before a three-class pilot
is selected.
